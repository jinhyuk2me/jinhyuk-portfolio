...
- **Content**: 로보틱스는 여러 공학 분야를 아우르는 종합 기술입니다. 시스템 설계부터 AI, 제어까지 폭넓은 경험을 바탕으로 실생활에서 바로 사용 가능한 로봇 시스템을 개발합니다.
...
### DUST: 스마트 물류 관제
- **제목**: DUST: 스마트 물류 관제
- **설명**: AGV, 컨베이어, 게이트를 통합 제어하는 IoT 플랫폼입니다. 바이너리 프로토콜 사용으로 응답 속도를 3배 향상시켰고, RFID 인식 시 타이밍 제어를 통해 주행 안정성을 확보했습니다.
...
- **설명**: 전기및전자공학부 학부 과정 재학 중

### Addinedu IT Academy
- **학교명**: 애드인에듀 IT 아카데미
- **전공/과정**: ROS2 & AI 자율주행 로봇 부트캠프
- **기간**: 2025.02 - 2025.08
- **설명**: ROS2, 자율주행, 딥러닝, 임베디드 시스템 집중 교육 과정 수료. 팀 리더로서 5개의 주요 프로젝트를 성공적으로 완수
